...
**Active scope (2026-06-10)**: IFC/SKP → Web 3D + AR MVP — simplified flow (no auth), local `/data` storage, single converter sidecar (IfcOpenShell + Blender + `usd_from_gltf`), direct file serving without redirects, `thumbnail.webp`. See plan.md.
...
- `specs/001-ifc-mvp-platform/research.md` — technology decisions (R-11…R-20)
...
Active feature: `001-ifc-mvp-platform` (Arch3DAR — IFC/SKP-to-AR 3D Sharing MVP).
