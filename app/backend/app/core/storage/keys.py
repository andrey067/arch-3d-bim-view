...
Keys are **always relative** to the storage root::

    originals/<project_id>/<model_file_id>__<sanitized_filename>
    converted/<project_id>/<model_file_id>.glb
    usdz/<project_id>/<model_file_id>.usdz
    qr/<project_id>/<model_file_id>.png
"""
...
def usdz_key(project_id: str, model_file_id: str) -> str:
    """Return the storage key for a converted USDZ file."""
    return f"usdz/{project_id}/{model_file_id}.usdz"


def qr_key(project_id: str, model_file_id: str) -> str:
    """Return the storage key for a QR code PNG."""
    return f"qr/{project_id}/{model_file_id}.png"
