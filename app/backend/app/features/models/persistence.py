"""Database queries for ModelFile — simplified for str IDs."""
...
def get_model_file_by_id(session: Session, model_file_id: str) -> ModelFile | None:
...
def list_model_files(
    ...
    *,
    ...
    if cursor:
        stmt = stmt.where(ModelFile.id > cursor)
